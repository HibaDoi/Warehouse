...
document.querySelectorAll('input[name="roomSelect"]').forEach(function(radio) {
    radio.addEventListener('change', function() {
        ...
        document.getElementById('rooom1Graphss').style.display = 'none';
        document.getElementById('rooom2Graphss').style.display = 'none';
        document.getElementById('rooom3Graphss').style.display = 'none';

        // Show the selected room's graphs
        var selectedRoom = this.value; // Gets the selected radio button's value
        if(selectedRoom === 'room1') {
            document.getElementById('rooom1Graphss').style.display = 'block';
        } else if(selectedRoom === 'room2') {
            document.getElementById('rooom2Graphss').style.display = 'block';
        } else if(selectedRoom === 'room3') {
            document.getElementById('rooom3Graphss').style.display = 'block';
        }
    });
});
